/**
 * Unit Test Suite for Naukri Two-Layer Decision Pipeline
 */
...
function evaluateNaukriJob(job, appliedHistory = {}) {
...
console.log('=== RUNNING NAUKRI TWO-LAYER DECISION PIPELINE TESTS ===\n');

const applied = { 'nk-101': true };
const tests = [
  {
    name: '1. Negative: Technical Co-Founder @ Naukri',
    job: { id: 'nk-201', title: 'Technical Co-Founder', experience: '1 - 3 Yrs', location: 'Remote', skills: 'React, Node.js' },
    expectedPass: false,
    expectedReasonPrefix: 'HARD_TITLE_EXCLUSION',
  },
  {
    name: '2. Negative: Naukri tuple with 4 - 8 Yrs experience',
    job: { id: 'nk-202', title: 'Frontend Developer', experience: '4 - 8 Yrs', location: 'Bengaluru', skills: 'React, TypeScript' },
    expectedPass: false,
    expectedReasonPrefix: 'EXPERIENCE_EXCEEDS_LIMIT',
  },
  {
    name: '3. Negative: Non-priority on-site location (Jaipur On-site)',
    job: { id: 'nk-203', title: 'Full Stack Developer', experience: '1 - 3 Yrs', location: 'Jaipur', skills: 'React, Node.js' },
    expectedPass: false,
    expectedReasonPrefix: 'NON_PRIORITY_ONSITE_LOCATION',
  },
  {
    name: '4. Negative: Full Stack Developer with only Java/Spring',
    job: { id: 'nk-204', title: 'Full Stack Developer', experience: '1 - 3 Yrs', location: 'Bengaluru', skills: 'Java, Spring Boot, MySQL' },
    expectedPass: false,
    expectedReasonPrefix: 'FULLSTACK_MISSING_REACT_STACK',
  },
  {
    name: '5. Negative: External company site redirect link',
    job: { id: 'nk-205', title: 'React Developer', experience: '1 - 3 Yrs', location: 'Bengaluru', skills: 'React.js', isExternalRedirect: true },
    expectedPass: false,
    expectedReasonPrefix: 'EXTERNAL_ATS_REDIRECT',
  },
  {
    name: '6. Negative: Duplicate Job ID nk-101',
    job: { id: 'nk-101', title: 'React Developer', experience: '1 - 3 Yrs', location: 'Bengaluru', skills: 'React.js, Next.js' },
    expectedPass: false,
    expectedReasonPrefix: 'ALREADY_APPLIED',
  },
  {
    name: '7. Positive: React Developer @ Bengaluru (1 - 3 Yrs, React, Next, TS, Tailwind)',
    job: { id: 'nk-301', title: 'React Developer', experience: '1 - 3 Yrs', location: 'Bengaluru', skills: 'React.js, Next.js, TypeScript, Tailwind CSS, REST APIs' },
    expectedPass: true,
    minScore: 85,
  },
  {
    name: '8. Positive: Frontend Engineer @ Work from home (0 - 2 Yrs, Next.js, React, Node)',
    job: { id: 'nk-302', title: 'Frontend Engineer', experience: '0 - 2 Yrs', location: 'Work from home', skills: 'Next.js, React.js, JavaScript, Node.js, Tailwind CSS' },
    expectedPass: true,
    minScore: 85,
  },
];
...
for (const tc of tests) {
  const res = evaluateNaukriJob(tc.job, applied);
...
if (allPassed) {
  console.log('🎉 ALL NAUKRI PIPELINE TESTS PASSED WITH 100% ACCURACY!');
} else {
  process.exit(1);
}
