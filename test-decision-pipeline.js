...
function evaluateJob(job, appliedIds = {}) {
  ...
  if (appliedIds[job.id]) {
    return {
      pass: false,
      layer: 1,
      reason: `ALREADY_APPLIED (Job ID: ${job.id})`,
    };
  }
...
const testCases = [
  {
    ...
    job: {
      ...
      location: "Remote",
      jd: "Looking for a technical co-founder with React, Node.js, 1-2 years experience.",
    },
    expectedPass: false,
  ...
  },
  {
    ...
    job: {
      ...
      jd: "Looking for Full Stack Developer in Jaipur office. Must work on-site in Jaipur. React, Node.js, 1-3 years experience.",
    },
    expectedPass: false,
  ...
  },
  {
    ...
    job: {
      ...
      location: "Bengaluru",
      jd: "We are looking for Frontend Engineer with 2-5 years of experience building modern web apps with React and TypeScript.",
    },
    expectedPass: false,
  ...
  },
  {
    ...
    job: {
      ...
      title: "Full Stack Developer",
      location: "Bengaluru",
      jd: "Looking for Full Stack Engineer with Java, Spring Boot, Hibernate, Oracle DB, and Angular.",
    },
    expectedPass: false,
  ...
  },
  {
    ...
    job: {
      ...
      location: "Bengaluru",
      jd: "Looking for Full Stack Engineer with React, Node.js, 1-3 years experience.",
    },
    expectedPass: false,
    expectedReasonPrefix: "HARD_TITLE_EXCLUSION",
  },
  {
    ...
    job: {
      ...
      title: "Full Stack Developer",
      location: "Bengaluru",
      jd: "Full Stack Developer with React, Node.js, 1-3 years experience.",
    },
    expectedPass: false,
  ...
  },
  {
    ...
    job: {
      ...
      location: "Bengaluru",
      jd: "We are hiring a React Developer with 1-2 years experience. Tech stack: React.js, Next.js, TypeScript, Tailwind CSS, REST APIs, Git.",
      postedHours: 4,
    },
    expectedPass: true,
    minScore: 85,
  },
  {
    ...
    job: {
      ...
      jd: "Fast-growing startup looking for Frontend Engineer (0-2 years). Build features with Next.js, React, Node.js, Tailwind CSS.",
      postedHours: 12,
    },
    expectedPass: true,
    minScore: 85,
...
for (const tc of testCases) {
  ...
  console.log(
    `  -> Passed: ${result.pass} | Layer: ${result.layer} | Score: ${result.score || "N/A"}`,
  );
  ...
  if (tc.expectedPass) {
    if (!result.pass || (tc.minScore && result.score < tc.minScore)) {
      console.error(
        `  ❌ FAILED: Expected pass with score >= ${tc.minScore}, got ${result.pass} (${result.score})`,
      );
      allPassed = false;
    } else {
      console.log(`  ✅ PASSED\n`);
    ...
    if (result.pass || !result.reason.startsWith(tc.expectedReasonPrefix)) {
      console.error(
        `  ❌ FAILED: Expected fail with ${tc.expectedReasonPrefix}, got ${result.reason}`,
      );
      allPassed = false;
    } else {
      console.log(`  ✅ PASSED\n`);
