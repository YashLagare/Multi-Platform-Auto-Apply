/**
 * Unit Test Suite for Instahyre Two-Layer Decision Pipeline
 */
...
function evaluateInstahyreJob(job, appliedHistory = {}) {
  ...
  // Exp
  if (/\b(?:0\s*-\s*2|1\s*-\s*3|0\s*-\s*1|0\s*-\s*3)\s*yrs\b/.test(job.experience.toLowerCase())) {
  ...
  // Freshness
  score += 10; breakdown.push('Active Opportunity (+10)');
...
console.log('=== RUNNING INSTAHYRE TWO-LAYER DECISION PIPELINE TESTS ===\n');

const applied = { 'ih-101': true };
const tests = [
  {
    name: '1. Negative: Technical Co-Founder @ Instahyre',
    job: { id: 'ih-201', title: 'Technical Co-Founder', experience: '1 - 3 yrs', location: 'Remote', skills: 'React, Node.js' },
    expectedPass: false,
    expectedReasonPrefix: 'HARD_TITLE_EXCLUSION',
  },
  {
    name: '2. Negative: Instahyre card with 3 - 5 yrs experience',
    job: { id: 'ih-202', title: 'Frontend Engineer', experience: '3 - 5 yrs', location: 'Bengaluru', skills: 'React, TypeScript' },
    expectedPass: false,
    expectedReasonPrefix: 'EXPERIENCE_EXCEEDS_LIMIT',
  },
  {
    name: '3. Negative: Non-priority on-site location (Jaipur On-site)',
    job: { id: 'ih-203', title: 'Full Stack Developer', experience: '1 - 3 yrs', location: 'Jaipur', skills: 'React, Node.js' },
    expectedPass: false,
    expectedReasonPrefix: 'NON_PRIORITY_ONSITE_LOCATION',
  },
  {
    name: '4. Negative: Full Stack Developer with only Java/Spring',
    job: { id: 'ih-204', title: 'Full Stack Developer', experience: '1 - 3 yrs', location: 'Bengaluru', skills: 'Java, Spring Boot, Hibernate, MySQL' },
    expectedPass: false,
    expectedReasonPrefix: 'FULLSTACK_MISSING_REACT_STACK',
  },
  {
    name: '5. Negative: Duplicate Opportunity ID ih-101',
    job: { id: 'ih-101', title: 'React Developer', experience: '1 - 3 yrs', location: 'Bengaluru', skills: 'React.js, Next.js' },
    expectedPass: false,
    expectedReasonPrefix: 'ALREADY_APPLIED',
  },
  {
    name: '6. Positive: React Developer @ Bengaluru (1 - 3 yrs, React, Next, TS, Tailwind)',
    job: { id: 'ih-301', title: 'React Developer', experience: '1 - 3 yrs', location: 'Bengaluru', skills: 'React.js, Next.js, TypeScript, Tailwind CSS, REST APIs' },
    expectedPass: true,
    minScore: 85,
  },
  {
    name: '7. Positive: Frontend Engineer @ Work from home (0 - 2 yrs, Next.js, React, Node)',
    job: { id: 'ih-302', title: 'Frontend Engineer', experience: '0 - 2 yrs', location: 'Work from home', skills: 'Next.js, React.js, JavaScript, Node.js, Tailwind CSS' },
    expectedPass: true,
    minScore: 85,
  },
];
...
for (const tc of tests) {
  const res = evaluateInstahyreJob(tc.job, applied);
...
if (allPassed) {
  console.log('🎉 ALL INSTAHYRE PIPELINE TESTS PASSED WITH 100% ACCURACY!');
} else {
  process.exit(1);
}
